...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative p-4">
            ...
            <div className="glass-card w-full max-w-[450px] p-12 rounded-[24px]">
                <header className="text-center mb-10">
                    <div className="inline-block mb-4 p-3 rounded-2xl bg-gradient-to-br from-indigo-500 to-pink-500 text-white">
                        <Library size={48} />
                    </div>
                    <h1 className="text-3xl font-bold mb-2">Create Account</h1>
                    <p className="text-slate-500">Join our library community today.</p>
                </header>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Link to="/login" className="block w-full text-center py-4 bg-transparent border-2 border-indigo-100 text-indigo-600 font-semibold rounded-xl hover:bg-indigo-50 transition-all mt-4">
                        Back to Login
                    </Link>
                </form>
            </div>
